...
$GLOBALS_METADATA = array(
    ...
    'Connectors' => array(
        ...
        'twilio_auth_token' => array(
            ...
            'text',
            '',
            xl('Account Token for Twilio')
        ),
        'twilio_api_key' => array(
            xl('Twilio API Key'),
            'text',
            '',
            xl('API Key for Twilio')
        ),
        'twilio_secret_key' => array(
            xl('Twilio Secret Key'),
            'text',
            '',
            xl('Secret Account Key for Twilio')
        ),
        'twilio_patient_link' => array(
            xl('Twilio Patient Link'),
            'text',
            '',
            xl('Patient Link for Twilio Account')
        ),
        'tele_consult_new_window' => array(
            xl('Patient Tele Consult New Window'),
            'bool',                           // data type
            '0',                              // default = false
